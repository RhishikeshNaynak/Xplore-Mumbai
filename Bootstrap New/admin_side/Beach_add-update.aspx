<%@ Page Title="" Language="C#" MasterPageFile="~/admin_side/Site1.Master" AutoEventWireup="true" CodeBehind="Beach_add-update.aspx.cs" Inherits="botstrap.admin_side.Beach_add_update" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <p style="font-family: Arial, Helvetica, sans-serif; font-size: 25px; text-transform: uppercase; color: #000000; font-weight: bolder; vertical-align: middle;" >
        INSERT UPDATE AND DELETE TOUR BEACH INFORMATION HERE:- 
    </p>
    <div style="vertical-align: middle; text-align: center"  >
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:projectConnectionString %>" DeleteCommand="DELETE FROM [beaches_info] WHERE [place_id] = @place_id" InsertCommand="INSERT INTO [beaches_info] ([place], [first], [second], [third], [fourth]) VALUES (@place, @first, @second, @third, @fourth)" SelectCommand="SELECT * FROM [beaches_info]" UpdateCommand="UPDATE [beaches_info] SET [place] = @place, [first] = @first, [second] = @second, [third] = @third, [fourth] = @fourth WHERE [place_id] = @place_id">
            <DeleteParameters>
