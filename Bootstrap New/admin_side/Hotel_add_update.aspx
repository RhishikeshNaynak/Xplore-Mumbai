<%@ Page Title="" Language="C#" MasterPageFile="~/admin_side/Site1.Master" AutoEventWireup="true" CodeBehind="Hotel_add_update.aspx.cs" Inherits="botstrap.admin_side.Hotel_add_update" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <p style="font-family: Arial, Helvetica, sans-serif; font-size: 25px; text-transform: uppercase; color: #000000; font-weight: bolder; vertical-align: middle;" >
        INSERT UPDATE AND DELETE HOTEL INFORMATION HERE:- 
    </p>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="hotel_id" DataSourceID="SqlDataSource1" ShowFooter="True">
        <Columns>
            ...
            <asp:TemplateField HeaderText="hotel_id" InsertVisible="False" SortExpression="hotel_id">
                <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="hotel_name" SortExpression="hotel_name">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("hotel_name") %>'></asp:TextBox>
                      <asp:RequiredFieldValidator ID="rfvInsertName" runat="server" 
                            ErrorMessage="hotel_name is a required field" 
                            ControlToValidate="TextBox1" Text="*" ForeColor="Red">
                       </asp:RequiredFieldValidator>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("hotel_name") %>'></asp:Label>
                </ItemTemplate>
                  <FooterTemplate>
            ...
            <asp:TemplateField HeaderText="fourth_line" SortExpression="fourth_line">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox6" runat="server" Text='<%# Bind("fourth_line") %>'></asp:TextBox>
                ...
                <ItemTemplate>
                    <asp:Label ID="Label7" runat="server" Text='<%# Bind("fourth_line") %>'></asp:Label>
                </ItemTemplate>
                 <FooterTemplate>
            ...
            <asp:TemplateField HeaderText="fifth_line" SortExpression="fifth_line">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox5" runat="server" Text='<%# Bind("fifth_line") %>'></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfvInsertfif" runat="server" 
                            ErrorMessage="fifth_line is a required field" 
                            ControlToValidate="TextBox5" Text="*" ForeColor="Red">
                       </asp:RequiredFieldValidator>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label6" runat="server" Text='<%# Bind("fifth_line") %>'></asp:Label>
                </ItemTemplate>
                 <FooterTemplate>
                        <asp:TextBox ID="txtfifith" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvInsertfif" runat="server" 
                            ErrorMessage="fifth_line is a required field" 
                            ControlToValidate="txtfifith" Text="*" ForeColor="Red"
                            ValidationGroup="Insert">
                       </asp:RequiredFieldValidator>
                    </FooterTemplate>
            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:projectConnectionString %>" DeleteCommand="DELETE FROM [hotel_info] WHERE [hotel_id] = @hotel_id" InsertCommand="INSERT INTO [hotel_info] ([hotel_name], [first_line], [second_line], [third_line], [fourth_line], [fifth_line]) VALUES (@hotel_name, @first_line, @second_line, @third_line, @fourth_line, @fifth_line)" SelectCommand="SELECT * FROM [hotel_info]" UpdateCommand="UPDATE [hotel_info] SET [hotel_name] = @hotel_name, [first_line] = @first_line, [second_line] = @second_line, [third_line] = @third_line, [fourth_line] = @fourth_line, [fifth_line] = @fifth_line WHERE [hotel_id] = @hotel_id">
        <DeleteParameters>
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="fifth_line" Type="String" />
        </InsertParameters>
        <UpdateParameters>
            <asp:Parameter Name="hotel_name" Type="String" />
            <asp:Parameter Name="first_line" Type="String" />
