<%@ Page Title="" Language="C#" MasterPageFile="~/admin_side/Site1.Master" AutoEventWireup="true" CodeBehind="Place_add_update.aspx.cs" Inherits="botstrap.admin_side.Place_add_update" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
   <p style="font-family: Arial, Helvetica, sans-serif; font-size: 25px; text-transform: uppercase; color: #000000; font-weight: bolder; vertical-align: middle;" >
        INSERT UPDATE AND DELETE TOUR PLACES INFORMATION HERE:- 
    </p>
    <div style="vertical-align: middle; text-align: center"  >
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:projectConnectionString %>" DeleteCommand="DELETE FROM [places_info] WHERE [place_id] = @place_id" InsertCommand="INSERT INTO [places_info] ([place], [first_line], [second_line], [third_line], [fourth_line]) VALUES (@place, @first_line, @second_line, @third_line, @fourth_line)" SelectCommand="SELECT * FROM [places_info]" UpdateCommand="UPDATE [places_info] SET [place] = @place, [first_line] = @first_line, [second_line] = @second_line, [third_line] = @third_line, [fourth_line] = @fourth_line WHERE [place_id] = @place_id">
            <DeleteParameters>
