<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WALKESHWAR.aspx.cs" Inherits="botstrap.FULL_CLIENT_SIDE.TEMPLES.WALKESHWAR" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>WALKESHWAR TEMPLE</title>
    <meta charset="utf-8">
...
<body style="background-color:#a3e4d7;">
     <form id="form1" runat="server">
        ...
        <asp:Label ID="lbl" runat="server" Text="WALKESHWAR TEMPLE" value="WALKESHWAR TEMPLE" ></asp:Label>                
            </h2>
                ...
                <div id="imageCarousel" class="carousel slide" data-interval="2000"
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="Images/walkeshwar1.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                        ...
                        <div class="item">
                            <img src="Images/walkeshwar2.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>WALKESHWAR TEMPLE</h3>
