<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MUMBADEVI.aspx.cs" Inherits="botstrap.FULL_CLIENT_SIDE.TEMPLES.MUMBADEVI" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>MUMBADEVI TEMPLE</title>
    <meta charset="utf-8">
...
<body  style="background-color:#a3e4d7;">
     <form id="form1" runat="server">
        ...
        <asp:Label ID="lbl" runat="server" Text="MUMBADEVI TEMPLE" value="MUMBADEVI TEMPLE" ></asp:Label>                
            </h2>
                ...
                <div id="imageCarousel" class="carousel slide" data-interval="2000"
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="Images/mumbadevi-temple1.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>MUMBADEVI TEMPLE</h3>
                                
                            </div>
                        </div>
                        <div class="item">
                            <img src="Images/mumbadevi-temple2.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>MUMBADEVI TEMPLE</h3>
