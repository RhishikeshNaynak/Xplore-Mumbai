<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BABULNATH.aspx.cs" Inherits="botstrap.FULL_CLIENT_SIDE.TEMPLES.BABULNATH" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>BABULNATH TEMPLE </title>
    <meta charset="utf-8">
...
<h2 style="font-family: Arial, Helvetica, sans-serif; height:70px; font-size: 50px; font-weight: bolder; font-style: normal;  text-transform: uppercase; color:#fdfefe ; vertical-align: middle; text-align: center; text-indent: inherit; background-color:#0b5345;">
        <asp:Label ID="lbl" runat="server" Text="BABULNATH TEMPLE" value="BABULNATH TEMPLE" ></asp:Label>                
            </h2>
                ...
                <div id="imageCarousel" class="carousel slide" data-interval="2000"
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="Images/Babulnath1.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>BABULNATH TEMPLE</h3>
                                
                            </div>
                        </div>
                        <div class="item">
                            <img src="Images/Babulnath2.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>BABULNATH TEMPLE</h3>
