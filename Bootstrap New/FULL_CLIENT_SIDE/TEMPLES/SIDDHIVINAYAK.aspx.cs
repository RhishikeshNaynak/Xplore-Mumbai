...
namespace botstrap.FULL_CLIENT_SIDE.TEMPLES
{
    public partial class SIDDHIVINAYAK : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                objConn.Open();
                lbl.Text = "SIDDHIVINAYAK TEMPLE";
                String strQuery = "select first_line,second_line,third_line,fourth_line from temples_info where place='" + lbl.Text + "'";
