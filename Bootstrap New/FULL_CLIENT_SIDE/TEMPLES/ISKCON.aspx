<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ISKCON.aspx.cs" Inherits="botstrap.FULL_CLIENT_SIDE.TEMPLES.ISKCON" %>
...
<body style="background-color:#a3e4d7;">
     <form id="form1" runat="server">
       <h2 style="font-family: Arial, Helvetica, sans-serif; height:70px; font-size: 50px; font-weight: bolder; font-style: normal; text-transform: uppercase; color:#fdfefe ; vertical-align: middle; text-align: center; text-indent: inherit; background-color:#0b5345;">
        <asp:Label ID="lbl" runat="server" Text="ISKCON TEMPLES" value="ISKCON TEMPLES" ></asp:Label>                
            </h2>
                ...
                <div id="imageCarousel" class="carousel slide" data-interval="2000"
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="Images/ISKCON1.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                        ...
                        <div class="item">
                            <img src="Images/ISKCON2.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>ISKCON TEMPLE</h3>
