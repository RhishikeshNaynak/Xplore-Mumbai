<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VASTU.aspx.cs" Inherits="botstrap.FULL_CLIENT_SIDE.PLACES.VASTU" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Vastu Sangrhalaya </title>
    <meta charset="utf-8">
...
<body  style="background-color: #a9cce3 ;">
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lbl" runat="server" Text="CMS VASTU SANGRAHALAYA" value="CMS VASTU SANGRAHALAYA" ></asp:Label>                
            </h2>
                ...
                <div id="imageCarousel" class="carousel slide" data-interval="2000"
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="Images/vastu1.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>C S M Vastu Sangrahalaya</h3>
                                
                            </div>
                        </div>
                        <div class="item">
                            <img src="Images/vastu2.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>C S M Vastu Sangrahalaya</h3>
