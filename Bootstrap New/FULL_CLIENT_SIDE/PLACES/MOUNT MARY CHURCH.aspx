<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MOUNT MARY CHURCH.aspx.cs" Inherits="botstrap.FULL_CLIENT_SIDE.PLACES.MOUNT_MARY_CHURCH" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Mount mary church</title>
    <meta charset="utf-8">
...
<body style="background-color: #a9cce3 ;">
    <form id="form1" runat="server">
       ...
       <h2 style="font-family: Arial, Helvetica, sans-serif; height:70px; font-size: 50px; font-weight: bolder; font-style: normal; text-transform: uppercase; color:#fdfefe ; vertical-align: middle; text-align: center; text-indent: inherit; background-color:#154360;">
        <asp:Label ID="lbl" runat="server" Text="MOUNT MARY CHURCH" value="MOUNT MARY CHURCH" ></asp:Label>                
            </h2>
                ...
                <div id="imageCarousel" class="carousel slide" data-interval="2000"
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="Images/mount1.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                        ...
                        <div class="item">
                            <img src="Images/mount2.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>Mount  Mary  Church  </h3>
