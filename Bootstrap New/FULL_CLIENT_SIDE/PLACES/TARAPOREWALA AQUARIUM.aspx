<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TARAPOREWALA AQUARIUM.aspx.cs" Inherits="botstrap.FULL_CLIENT_SIDE.PLACES.TARAPOREWALA_AQUARIUM" %>
...
<h2 style="font-family: Arial, Helvetica, sans-serif; height:70px; font-size: 50px; font-weight: bolder; font-style: normal; text-transform: uppercase; color:#fdfefe ; vertical-align: middle; text-align: center; text-indent: inherit; background-color:#154360;">
        <asp:Label ID="lbl" runat="server" Text="TARAPOREWALA AQUARIUM" value="TARAPOREWALA AQUARIUM" ></asp:Label>                
            </h2>
                ...
                <div id="imageCarousel" class="carousel slide" data-interval="2000"
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="Images/tarapor1.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                        ...
                        <div class="item">
                            <img src="Images/tarapor2.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>Taraporewala  Aquarium</h3>
                          ...
                          <div class="item">
                            <img src="Images/tarapor3.gif" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>Taraporewala  Aquarium</h3>
