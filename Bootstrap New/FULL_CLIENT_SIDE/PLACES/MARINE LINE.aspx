<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MARINE LINE.aspx.cs" Inherits="botstrap.FULL_CLIENT_SIDE.PLACES.MARINE_LINE" %>
...
<body style="background-color: #a9cce3 ;">
     <form id="form1" runat="server">
        ...
        <asp:Label ID="lbl" runat="server" Text="MARINE DRIVE" value="MARINE DRIVE" ></asp:Label>                
            </h2>
                ...
                <div id="imageCarousel" class="carousel slide" data-interval="2000"
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="Images/marine-drive1.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                        ...
                        <div class="item">
                            <img src="Images/marine-drive2.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>MARINE DRIVE</h3>
                        ...
                        <div class="item">
                            <img src="Images/marine-drive3.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                               <h3>MARINE DRIVE</h3>
