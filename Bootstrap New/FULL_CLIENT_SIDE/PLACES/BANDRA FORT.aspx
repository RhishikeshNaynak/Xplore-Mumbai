<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BANDRA FORT.aspx.cs" Inherits="botstrap.FULL_CLIENT_SIDE.PLACES.BANDRA_FORT" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml" id="bgbag">
<head>
...
<body style="background-color: #a9cce3 ;">
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lbl" runat="server" Text="BANDRA FORT" value="BANDRA FORT" ></asp:Label>                
            </h2>
        </div>
