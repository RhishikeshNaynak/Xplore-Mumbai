<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GATEWAY OF INDIA.aspx.cs" Inherits="botstrap.FULL_CLIENT_SIDE.PLACES.GATEWAY_OF_INDIA" %>
...
<body style="background-color: #a9cce3 ;">
     <form id="form1" runat="server">
        ...
        <asp:Label ID="lbl" runat="server" Text="GATEWAY OF INDIA" value="GATEWAY OF INDIA" ></asp:Label>                
            </h2>
                ...
                <div id="imageCarousel" class="carousel slide" data-interval="2000"
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="Images/one.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>GATWAY OF INDIA</h3>
                                
                            </div>
                        </div>
                        <div class="item">
                            <img src="Images/gate2.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>GATWAY OF INDIA</h3>
                        ...
                        <div class="item">
                            <img src="Images/gate3.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                               <h3>GATWAY OF INDIA</h3>
