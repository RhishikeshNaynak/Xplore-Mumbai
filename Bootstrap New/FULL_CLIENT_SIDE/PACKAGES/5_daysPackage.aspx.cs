...
{
    public partial class _4_daysPackage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                objConn.Open();
                Label11.Text = "5 DAYS";
                String strQuery = "select day1,day11,day2,day22,day3,day33,day4,day44,day5,day55 from fivedaystour where tour='" + Label11.Text + "'";
                ...
                while (reader.Read())
                {
                    ...
                    Label9.Text = reader["day5"] + "";
                    Label10.Text = reader["day55"] + "";
