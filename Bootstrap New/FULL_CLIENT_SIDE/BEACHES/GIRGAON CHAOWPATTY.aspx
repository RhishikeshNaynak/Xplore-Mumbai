<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GIRGAON CHAOWPATTY.aspx.cs" Inherits="botstrap.FULL_CLIENT_SIDE.BEACHES.GIRGAON_CHAOWPATTY" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>GIRGAON CHOWPATTY BEACH</title>
    <meta charset="utf-8">
...
<body style="background-color: #aed6f1;">
    <form id="form1" runat="server">
       <h2 style="font-family: Arial, Helvetica, sans-serif; height:70px; font-size: 50px; font-weight: bolder; font-style: normal; text-transform: uppercase; color:#fdfefe ; vertical-align: middle; text-align: center; text-indent: inherit; background-color:#2874a6">
        <asp:Label ID="lbl" runat="server" Text="GIRGAON CHAOWPATTY BEACH" value="GIRGAON CHAOWPATTY BEACH" ></asp:Label>                
            </h2>
                ...
                <div id="imageCarousel" class="carousel slide" data-interval="2000"
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="Images/girgaon1.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>GIRGAON&nbsp; CHOWPATTY</h3>
                                
                            </div>
                        </div>
                        <div class="item">
                            <img src="Images/girgaon2.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                         ...
                         <div class="item">
                            <img src="Images/girgaon4.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>DADAR CHOWPATTY</h3>
