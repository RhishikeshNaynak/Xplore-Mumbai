<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AKSA BEACH.aspx.cs" Inherits="botstrap.FULL_CLIENT_SIDE.BEACHES.AKSA_BEACH" %>

<!DOCTYPE html>
<html>
<head>
    <title>AKSA BEACH</title>
    <meta charset="utf-8">
...
<body style="background-color: #aed6f1;">
    ...
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lbl" runat="server" Text="AKSA BEACH" value="AKSA BEACH" ></asp:Label>                
            </h2>
                ...
                <div id="imageCarousel" class="carousel slide" data-interval="2000"
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="Images/aksa1.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                        ...
                        <div class="item">
                            <img src="Images/aksa3.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>AKSA BEACH</h3>
                        ...
                        <div class="item">
                            <img src="Images/aksa4.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>AKSA BEACH</h3>
