...
namespace botstrap.FULL_CLIENT_SIDE.BEACHES
{
    public partial class GIRGAON_CHAOWPATTY : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                objConn.Open();
                lbl.Text = "GIRGAON CHAOWPATTY BEACH";
                String strQuery = "select first_line,second_line,third_line,fourth_line from beaches_info where place='" + lbl.Text + "'";
