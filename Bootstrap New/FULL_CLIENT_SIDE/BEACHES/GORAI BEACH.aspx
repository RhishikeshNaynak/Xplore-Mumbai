<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GORAI BEACH.aspx.cs" Inherits="botstrap.FULL_CLIENT_SIDE.BEACHES.GORAI_BEACH" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>GORAI BEACH </title>
    <meta charset="utf-8">
...
<h2 style="font-family: Arial, Helvetica, sans-serif; height:70px; font-size: 50px; font-weight: bolder; font-style: normal; text-transform: uppercase; color:#fdfefe ; vertical-align: middle; text-align: center; text-indent: inherit; background-color:#2874a6">
        <asp:Label ID="lbl" runat="server" Text="GORAI BEACH" value="GORAI BEACH" ></asp:Label>                
            </h2>
                ...
                <div id="imageCarousel" class="carousel slide" data-interval="2000"
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="Images/gorai3.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                        ...
                        <div class="item">
                            <img src="Images/gorai4.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>GORAI BEACH</h3>
