<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VARSOVA BEACH.aspx.cs" Inherits="botstrap.FULL_CLIENT_SIDE.BEACHES.VARSOVA_BEACH" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>VARSOVA BEACH </title>
    <meta charset="utf-8">
...
<body style="background-color: #aed6f1;">
     <form id="form1" runat="server">
        ...
        <asp:Label ID="lbl" runat="server" Text="VERSOVA BEACH" value="VERSOVA BEACH" ></asp:Label>                
            </h2>
                ...
                <div id="imageCarousel" class="carousel slide" data-interval="2000"
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="Images/Versova1.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                        ...
                        <div class="item">
                            <img src="Images/Versova3.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>VARSOVA BEACH</h3>
