<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JUHU BEACH.aspx.cs" Inherits="botstrap.FULL_CLIENT_SIDE.BEACHES.JUHU_BEACH" %>
...
<body style="background-color: #aed6f1;">
     <form id="form1" runat="server">
        ...
        <asp:Label ID="lbl" runat="server" Text="JUHU BEACH" value="JUHU BEACH" ></asp:Label>                
            </h2>
                ...
                <div id="imageCarousel" class="carousel slide" data-interval="2000"
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="Images/juhu4.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                        ...
                        <div class="item">
                            <img src="Images/juhu2.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>JUHU BEACH</h3>
                        ...
                        <div class="item">
                            <img src="Images/juhu1.jpg" style="width: 1400px; height: 400px;" class="img-responsive">
                            <div class="carousel-caption">
                                <h3>JUHU BEACH</h3>
